    ...
    document.getElementById('detail-content').innerHTML = `
      ...
      <div class="dm-section">
        <div class="dm-section-title">
          ...
          <span class="tooltip-trigger" onclick="this.nextElementSibling.classList.toggle('show')">?</span>
          <div class="tooltip-text">一次性执行：下达指令后执行一次即完成（如查询、swap）<br>持续AI决策：AI持续自主运行、监控、自动做决策（如量化bot）<br>混合：部分自动+部分需用户确认</div>
        </div>
